...
import { WozObjectRequestByIds } from 'src/app/proto/wozobject.pb';
...
export class GetWozObjectsService {
  private getWozObjectsRequest$$: Subject<
    WozObjectRequestByIds
  > = new ReplaySubject<WozObjectRequestByIds>(1);
