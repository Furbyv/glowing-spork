...
import { SubobjectsRequestById, WozSubObjectReply, WozSubObjectsReply } from 'src/app/protos/subobject.pb';
import { SubObjectsClient } from 'src/app/protos/subobject.pbsc';

@Injectable({ providedIn: 'root' })
export class SubObjectsService {
  private subobjectsRequest$$: Subject<SubobjectsRequestById> = new ReplaySubject<SubobjectsRequestById>(1);

  subObjects$: Observable<AsyncState<WozSubObjectReply[]>> = this.subobjectsRequest$$.pipe(
