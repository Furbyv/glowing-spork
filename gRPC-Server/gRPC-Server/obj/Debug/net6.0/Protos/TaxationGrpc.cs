...
namespace gRPCServer.Protos {
  ...
  public static partial class TaxationObjects
  {
    ...
    {
      get { return global::gRPCServer.Protos.TaxationReflection.Descriptor.Services[0]; }
    }

    /// <summary>Base class for server-side implementations of TaxationObjects</summary>
    [grpc::BindServiceMethod(typeof(TaxationObjects), "BindService")]
    public abstract partial class TaxationObjectsBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::gRPCServer.Protos.TaxationsObject> GetTaxationsObject(global::gRPCServer.Protos.TaxationRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(TaxationObjectsBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_GetTaxationsObject, serviceImpl.GetTaxationsObject).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, TaxationObjectsBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetTaxationsObject, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::gRPCServer.Protos.TaxationRequest, global::gRPCServer.Protos.TaxationsObject>(serviceImpl.GetTaxationsObject));
    }
